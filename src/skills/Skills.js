        ...
        <div className={style.bigBlockSkills}>
            <div className={`${styleContainer.container} ${style.containerSkills}`}>
                ...
                <div className={style.littleBlockSkills}>
                    ...
                    <Skill title={'React'}
                           description={' Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание Описание моих навыков находится именно здесь!)'}/>
